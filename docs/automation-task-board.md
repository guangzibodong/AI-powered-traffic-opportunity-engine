...
| AUTO-002 | 2 | todo | Frontend Product Engineer | Extract task state and i18n support into small modules. | `App.tsx` shrinks, shared helpers are typed, and UI contract tests still pass. |
