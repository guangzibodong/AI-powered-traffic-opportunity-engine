...
- Local asset editor exposes read-only page-update false context without WordPress page updates, publishing, draft creation, sync execution, credential collection/storage, real OAuth, external writes, navigation, product edit, commerce-write, or task mutation controls.
- Local asset editor exposes read-only draft-creation false context without WordPress draft creation, page updates, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, product edit, commerce-write, or task mutation controls.
- Local asset editor exposes read-only product-edit false context without product edits, price edits, inventory edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only price-edit false context without price edits, inventory edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only inventory-edit false context without inventory edits, price edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only stock-status edit false context without stock status edits, inventory edits, price edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only product-content edit false context without product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only product-delete false context without product deletion, product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only product-image edit false context without product image edits, media uploads, product deletion, product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
- Local asset editor exposes read-only product-category edit false context without category edits, product image edits, media uploads, product deletion, product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, draft creation, publishing, sync execution, credential collection/storage, real OAuth, external writes, navigation, or task mutation controls.
