...
- Local asset editor QA aggregate diagnostics may expose check count, pending count, and readiness state as DOM attributes only; they must remain derived from local safe QA previews and cannot become QA workflow actions.
