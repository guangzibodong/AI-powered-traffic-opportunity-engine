...
10. Local asset claim ledger diagnostics include read-only row, row-source, total, and source distribution reconciliation against safe claim rows.
11. Local demo release handoff keeps live OAuth, credentials, WordPress drafts/page updates/publishing, and WooCommerce writes blocked.
