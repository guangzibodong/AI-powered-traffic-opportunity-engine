...
12. Visible local asset rows include read-only content block count reconciliation diagnostics that match row-visible type rows to safe content block counts.
13. Visible local asset rows include read-only QA readiness diagnostics that reconcile row readiness state with safe QA detail counts.
14. Visible local asset rows include read-only blocked capability diagnostics that reconcile row safety markers with safe blocked capability lists.
15. The asset workspace panel shows read-only blocked capability reconciliation diagnostics that match visible workspace safety rows to the workspace blocked capability count.
16. The asset workspace WordPress draft readiness row shows read-only count reconciliation diagnostics while draft creation, page updates, publishing, sync, OAuth, credentials, product edits, and commerce writes remain blocked.
17. The asset workspace external-write row shows read-only clamp reconciliation diagnostics while external writes remain false.
...
22. The asset workspace local review-state diagnostics reconcile existing asset review states without expanding product task statuses beyond `new`, `approved`, `rejected`, and `snoozed`.
23. The asset workspace source task diagnostics reconcile local asset candidates against their source task ids without adding task mutation, unsafe task statuses, drafts, publishing, sync, credentials, product edits, or commerce writes.
24. The asset workspace source task status diagnostics reconcile safe source task statuses without expanding product task statuses beyond `new`, `approved`, `rejected`, and `snoozed`.
25. The asset workspace QA aggregate diagnostics reconcile visible plus hidden QA check and pending counts against the root local asset QA totals.
26. The asset workspace QA readiness diagnostics reconcile root readiness state against root pending and total QA counts across populated, no-QA, and unavailable states.
27. The asset workspace content block aggregate diagnostics reconcile visible plus hidden local content block counts against the root local asset content block total.
28. The asset workspace content block type diagnostics reconcile workspace-level block type rows against the root local asset content block total.
29. The local asset editor shows read-only blocked capability reconciliation diagnostics that match visible safety rows to the editor blocked capability count.
30. The local asset editor shows read-only content block type distribution diagnostics that reconcile to the selected asset's safe content block count without adding rich text, draft, publish, sync, credential, product edit, or commerce-write controls.
31. The local asset editor shows read-only content block count reconciliation diagnostics that match editor-visible type rows to the selected asset's safe content block count.
...
36. The local asset editor shows read-only asset type context without adding asset type mutation, task mutation, draft, publish, sync, credential, product edit, or commerce-write controls.
37. The local asset editor shows read-only local asset review-state context without adding review mutation, task status expansion, draft, publish, sync, credential, product edit, or commerce-write controls.
38. The local asset editor shows read-only evidence summary context from safe local claim counts without adding claim editing, task mutation, draft, publish, sync, credential, product edit, or commerce-write controls.
39. The local asset editor shows read-only WordPress draft readiness context as blocked `0/1 ready` diagnostics without creating drafts, updating pages, publishing, syncing, collecting credentials, or writing commerce data.
40. The local asset editor shows read-only external-write false context from safe local asset previews without adding external writes, draft creation, page updates, publishing, sync, credentials, product edits, or commerce writes.
...
45. The local asset editor shows read-only page-update false context without WordPress page updates, publishing, draft creation, sync execution, real OAuth, credential collection/storage, external writes, product edits, or commerce writes.
46. The local asset editor shows read-only draft-creation false context without WordPress draft creation, page updates, publishing, sync execution, real OAuth, credential collection/storage, external writes, product edits, or commerce writes.
47. The local asset editor shows read-only product-edit false context without product edits, price edits, inventory edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
48. The local asset editor shows read-only price-edit false context without price edits, inventory edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
49. The local asset editor shows read-only inventory-edit false context without inventory edits, price edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
50. The local asset editor shows read-only stock-status edit false context without stock status edits, inventory edits, price edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
51. The local asset editor shows read-only product-content edit false context without product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
52. The local asset editor shows read-only product-delete false context without product deletion, product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
53. The local asset editor shows read-only product-image edit false context without product image edits, media uploads, product deletion, product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
54. The local asset editor shows read-only product-category edit false context without category edits, product image edits, media uploads, product deletion, product content edits, stock status edits, inventory edits, price edits, product edits, WooCommerce writes, drafts, publishing, sync execution, real OAuth, credential collection/storage, or external writes.
55. Local demo release handoff keeps live OAuth, credentials, WordPress drafts/page updates/publishing, and WooCommerce writes blocked.
