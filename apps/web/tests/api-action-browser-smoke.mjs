...
async function assertLocalAssetEditorCanSave(
  ...
  await assertLocalAssetEditorDirtyState(editor, "dirty", `${label} edited`, 4, [
    "title",
    "meta_description",
    "faq_question",
    "faq_answer"
...
async function assertLocalAssetEditorFieldReadinessCanBecomeComplete(
  ...
  await assertLocalAssetEditorDirtyState(editor, "dirty", `${label} complete`, 5, [
    "meta_description",
    "structured_section",
    "faq_question",
    "faq_answer",
