...
async function assertLocalAssetEditorCanSave(
  ...
  await assertLocalAssetEditorDirtyState(editor, "dirty", `${label} edited`, 5, [
    "title",
    "meta_description",
    "faq_question",
    "faq_answer",
...
async function assertLocalAssetEditorFieldReadinessCanBecomeComplete(
  ...
  await assertLocalAssetEditorDirtyState(editor, "dirty", `${label} complete`, 6, [
    "meta_description",
    "structured_section",
    "faq_question",
    "faq_answer",
...
async function assertLocalAssetEditorResetLocalChanges(page, label, expectedTitle) {
  ...
  await assertLocalAssetEditorDirtyState(editor, "dirty", `${label} edited`, 9, [
    "title",
    "slug",
    "meta_title",
    "meta_description",
