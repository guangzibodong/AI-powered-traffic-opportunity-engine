...
assert(
  app.includes("data-asset-source-task-status-count"),
  "Asset workspace UI must expose stable asset source task status count diagnostics"
);
assert(
  app.includes("data-asset-source-task-status-total-count"),
  "Asset workspace UI must expose stable asset source task status total diagnostics"
);
assert(
  app.includes("data-asset-source-task-status-counts-reconciled"),
  "Asset workspace UI must expose stable asset source task status reconciliation diagnostics"
);
assert(
  app.includes('data-asset-source-task-status-row="true"'),
  "Asset workspace UI must expose stable asset source task status rows"
);
assert(
  app.includes("data-asset-source-task-status-key"),
  "Asset workspace UI must expose stable asset source task status key diagnostics"
);
assert(
  app.includes("data-asset-source-task-status-row-count"),
  "Asset workspace UI must expose stable asset source task status row count diagnostics"
);
...
assert(
  app.includes("data-asset-editor-evidence-count"),
  "Local asset editor UI must expose stable evidence count diagnostics"
);
assert(
...
assert(
  app.includes("data-asset-editor-credential-collection-allowed"),
  "Local asset editor UI must expose stable credential-collection clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-credential-collection-summary="true"'),
  "Local asset editor UI must expose stable visible credential-collection summary diagnostics"
);
assert(
  app.includes("data-asset-editor-sync-execution-allowed"),
  "Local asset editor UI must expose stable sync-execution clamp diagnostics"
);
assert(
...
assert(
  app.includes("data-asset-editor-wordpress-page-update-allowed"),
  "Local asset editor UI must expose stable WordPress page-update clamp diagnostics"
);
assert(
...
assert(
  app.includes("data-asset-editor-product-edit-allowed"),
  "Local asset editor UI must expose stable product-edit clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-product-edit-summary="true"'),
  "Local asset editor UI must expose stable visible product-edit summary diagnostics"
);
assert(
  app.includes("data-asset-editor-price-edit-allowed"),
  "Local asset editor UI must expose stable price-edit clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-price-edit-summary="true"'),
  "Local asset editor UI must expose stable visible price-edit summary diagnostics"
);
assert(
  app.includes("data-asset-editor-inventory-edit-allowed"),
  "Local asset editor UI must expose stable inventory-edit clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-inventory-edit-summary="true"'),
  "Local asset editor UI must expose stable visible inventory-edit summary diagnostics"
);
assert(
  app.includes("data-asset-editor-stock-status-edit-allowed"),
  "Local asset editor UI must expose stable stock-status edit clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-stock-status-edit-summary="true"'),
  "Local asset editor UI must expose stable visible stock-status edit summary diagnostics"
);
assert(
  app.includes("data-asset-editor-product-content-edit-allowed"),
  "Local asset editor UI must expose stable product-content edit clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-product-content-edit-summary="true"'),
  "Local asset editor UI must expose stable visible product-content edit summary diagnostics"
);
assert(
  app.includes("data-asset-editor-product-delete-allowed"),
  "Local asset editor UI must expose stable product-delete clamp diagnostics"
);
assert(
...
assert(
  app.includes("data-asset-editor-product-category-edit-allowed"),
  "Local asset editor UI must expose stable product-category edit clamp diagnostics"
);
assert(
  app.includes('data-asset-editor-product-category-edit-summary="true"'),
  "Local asset editor UI must expose stable visible product-category edit summary diagnostics"
);
